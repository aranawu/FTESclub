...
export function receiptEmail(registration, schoolName) {
  return {
    ...
    html: `<div style="font-family:Arial,'Microsoft JhengHei',sans-serif;color:#1f2937;line-height:1.7;max-width:680px;margin:auto">
      ...
      <p>家長您好，學生 <strong>${escapeHtml(registration.studentName)}</strong>（${escapeHtml(registration.grade)} ${escapeHtml(registration.className)}）的報名已送達。</p>
...
export function resultEmail(registration, schoolName) {
  return {
    ...
    html: `<div style="font-family:Arial,'Microsoft JhengHei',sans-serif;color:#1f2937;line-height:1.7;max-width:680px;margin:auto">
      ...
      <p>家長您好，學生 <strong>${escapeHtml(registration.studentName)}</strong>（${escapeHtml(registration.grade)} ${escapeHtml(registration.className)}）的目前結果如下：</p>
