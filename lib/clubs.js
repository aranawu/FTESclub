...
export const CLASS_BY_GRADE = Object.freeze({
  '1年級': '一年忠班',
  '2年級': '二年忠班',
  '3年級': '三年忠班',
  '4年級': '四年忠班',
...
export function classForGrade(grade) {
  return CLASS_BY_GRADE[grade] || '';
}

export function publicClubs() {
  return CLUBS.map(({ id, name, content, day, time, period, location, grades, capacity }) => ({
    id, name, content, day, time, period, location, grades, capacity,
  }));
}
